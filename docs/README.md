...
- [Tailcat remote access and federation](./user/tailcat.md)
...
- [Tailcat transport](./internals/tailcat.md)
- [Federation protocol](./internals/federation.md)
- [ADR 001: Tailcat and federation](./internals/adr-001-tailcat-transport-and-federation.md)
